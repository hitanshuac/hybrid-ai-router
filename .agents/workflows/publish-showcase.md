...
3. **Verify Documentation Assets (Dual-Presentation Mandate):**
   - Confirm that the recruiter-facing showcase PNG (`docs/assets/architecture_diagram_v3_0_0.png`) is referenced at the top of `README.md`.
...
5. Once approved, stage the files:
   - Run `git add README.md retrospective.md walkthrough.md docs/assets/architecture_diagram_v3_0_0.png`
6. Commit the changes:
   - Run `git commit -m "docs: sync v3.0.0 showcase documentation and SRE assets"`
